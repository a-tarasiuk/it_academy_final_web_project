...
public class AccountOfferListTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        String accountEmail = sessionAccount.getEmail();
        ...
        try {
            ...
            Optional<Account> findAccount = accountService.findAccountByEmail(accountEmail);
            if(findAccount.isPresent()) {
                Account account = findAccount.get();
                long accountId = account.getId();

                List<Offer> offers = offerService.findListOffersByAccountId(accountId);
